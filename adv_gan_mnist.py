...
class DCGAN:
    ...
    def train_GAN(self):
        ...
        for epoch in range(epochs):
            ...
            if epoch == 0:
                self.save_generated_images("orig", x_batch, 'images_mnist')
            if epoch % 5 == 0:
                self.save_generated_images(str(epoch), Gx_batch, 'images_mnist')
                self.save_generated_images(str(epoch), Gx_batch[misclassified], 'misclass_mnist')
