...
calib_imgs_path = root.joinpath("data")
...
if calibrate_camera == True:
    ...
    src = "rtsp://pythonadmin:Pycamera@192.168.1.4:554/cam/realmonitor?channel=1&subtype=0"
    ...
    while True:
        ...
        h, w = im_gray.shape[:2]
        dst = cv2.undistort(img_aruco, mtx, dist, None, newcameramtx)
        ...
        if corners == None:
            ...
            cv2.imshow("World co-ordinate frame axes", dst)
