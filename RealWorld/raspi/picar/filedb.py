...
class fileDB(object):
	...
	def get(self, name, default_value=None):
		"""Get value by data'imageSocket name. Default value is for the arguemants do not exist"""
		try:
			conf = open(self.db,'r')
	...
	def set(self, name, value):
		"""Set value by data'imageSocket name. Or create one if the arguement does not exist"""
